...
namespace Pulpy\CoreBundle\Services\Config\Loader;
...
class DbBackedConfigLoaderService extends AbstractConfigLoaderService {
    ...
    public function load($configname) {
        ...
        $configEntity = $this->em->getRepository('Pulpy\CoreBundle\Entity\HierarchicalConfig')->findOneByName($configname);
